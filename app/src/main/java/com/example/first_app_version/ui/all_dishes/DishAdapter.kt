...
// DishAdapter.kt (מעודכן – מציג את מספר התגובות בכרטיס)
// שימי לב: רק אם ב-DishLayout יש TextView עם id בשם reviewsCount
package com.example.first_app_version.ui.all_dishes
...
//            binding.reviewsCount.text = item.reviewsCount.toString()
